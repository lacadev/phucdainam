...
!function() {
/*!**********************************************!*\
  !*** ./block-gutenberg/slider-block/view.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
...
var initSliderBlock = function initSliderBlock() {
  var blocks = document.querySelectorAll('.laca-slider-block');
  blocks.forEach(function (block) {
    // Avoid dual initialization
    if (block.classList.contains('swiper-initialized')) return;
    var autoplay = block.dataset.autoplay === 'true';
    var delay = parseInt(block.dataset.delay) || 3000;
    var slidesPerView = parseInt(block.dataset.slidesPerView) || 1;
    var spaceBetween = parseInt(block.dataset.spaceBetween) || 0;
    var loop = block.dataset.loop === 'true';
    var pagination = block.dataset.pagination === 'true';
    var navigation = block.dataset.navigation === 'true';
    new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](block, {
      loop: loop,
      autoplay: autoplay ? {
        delay: delay,
...
/* harmony default export */ __webpack_exports__["default"] = (initSliderBlock);
}();
/******/ })()
;
